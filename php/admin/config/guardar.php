...
if (!Empty($_FILES["fileLogo"]["tmp_name"])){
	$target_dir = $_SERVER['DOCUMENT_ROOT'] . '/empresas/'.$_SESSION['bd']."/";
...
//AKI :: Modificar os filtros pq al filtrar no se va al siguiente pudiendo valdar erroenamente .
	...
	$js['img'] 	= '<img src="../../empresas/'.$_SESSION['bd'].'/logo.png"></img>';
}else{
	$js['err'] = true ;
}
...
$sql = "UPDATE config SET sendMailAdmin = $sendAdmin, sendMailUser = $sendUser, festivosON  = $festivos , ShowRow=$showInactivas, MinTime=$minTime ";
