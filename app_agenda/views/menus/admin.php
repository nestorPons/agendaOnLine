<div id="mnuContacto" data-role="charm" data-position="right">
	...
	<a href="mailto:<?= ADMIN_EMAIL ?>?Subject=Contacto agendaOnLine" target="_top">
		<?= ADMIN_EMAIL ?>
	</a>
</div>
...
<div id="navbar" class="app-bar" data-role="appbar">
	...
	<div class="contenedor-datepicker">
		...
		<input class='datepicker date <?= $cls_festivos ?>' type='text' value='<?= core\Tools::formatofecha($fecha) ?>' data-festivos-show=true data-min-date=<?= $minDate ?? null; ?>>
	...
	<ul id="tools" class="app-bar-menu no-flexible" data-flexdirection="reverse">
		...
		<div id="btnToday" class="app-bar-element no-flexible ">
			<i class="icon-calendar-1"></i>
			<span class="menulbl">Hoy</span>
		</div>
	</ul>
