...
dialog.close('dlgGuardar')},'json').fail(()=>notify.error('creando la cita en crearCita.js '))}else{notify.error('Complete todos los datos')
...
dialog.close('dlgGuardar')},stepper:function(index){let $visible=$('.steperCapa:visible')
